...
class GmailApi(object):
	...
	def get_auth_token(self)-> str:
		"""Returns a string JSON representation of this instance. It can be passed to from_authorized_user_info() as json.loads to create a new credential instance."""
